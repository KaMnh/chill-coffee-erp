...
begin
  ...
  -- Pre-check: enforce 1 final report per business_date. Partial unique index
  -- cash_close_reports_one_final_per_day cũng catch nhưng raw constraint
  -- violation message khó đọc. Pre-check để raise message thân thiện.
  if exists (
    select 1 from public.cash_close_reports
